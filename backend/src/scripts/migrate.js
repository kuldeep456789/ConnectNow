...
async function migrate() {
  try {
    ...
    await query(
      `CREATE INDEX IF NOT EXISTS idx_engagement_meeting_id ON engagement_scores(meeting_id)`,
    );
    await query(
      `CREATE INDEX IF NOT EXISTS idx_engagement_user_id ON engagement_scores(user_id)`,
    );
    await query(
      `CREATE INDEX IF NOT EXISTS idx_coaching_meeting_id ON coaching_suggestions(meeting_id)`,
    );
    await query(
